"""
Django settings for autumn_smoke_40620 project.
...
ROOT_URLCONF = 'autumn_smoke_40620.urls'
...
WSGI_APPLICATION = 'autumn_smoke_40620.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "autumn_smoke_40620 API",
    "DESCRIPTION": "API documentation for autumn_smoke_40620 App",
    "VERSION": "v1",
}
